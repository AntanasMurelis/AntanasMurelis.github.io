...
[View code on GitHub](https://github.com/AntanasMurelis/EpiStats)
...
<!-- <div class="image-container">
    <img src="images/SentimentAnalysis.png?raw=true" alt="Meshes Group" />
...
<html>
<head>
    <title>Your Portfolio Page</title>
    <style>
        .image-container {
        ...
        .image-container .left-image {
            width: 40%; /* Left image takes up 40% of the width */
            height: auto; /* Height is set to auto to maintain aspect ratio */
            margin: 2px; /* Optional: Adds some space around the image */
        }
        .image-container .right-image {
            width: 61%; /* Right image takes up 60% of the width */
            height: auto; /* Height is set to auto to maintain aspect ratio */
            margin: 0px; /* Optional: Adds some space around the image */
        }
    </style>
</head>
<body>
    <div class="image-container">
        <img class="left-image" src="images/SentimentAnalysis.png?raw=true" alt="Sentiment Analysis" />
...
<!-- <div style="display: flex; justify-content: center; align-items: center;">
    <img src="images/SentimentAnalysis.png?raw=true" style="width: 10%; height: auto; margin: 5px;" alt="Sentiment Analysis" />
    <img src="images/sentiment_map.gif?raw=true" style="width: 10%; height: auto; margin: 5px;" alt="Sentiment Map" />
</div> -->


<!-- <table style="border-collapse: collapse; border: none;">
    <tr>
        <td style="border: none;"><img src="images/SentimentAnalysis.png?raw=true" alt="Sentiment Analysis" style="width: 100%; height: auto;"/></td>
        <td style="border: none;"><img src="images/sentiment_map.gif?raw=true" alt="Sentiment Map" style="width:100%; height: auto;"/></td>
    </tr>
</table> -->
...
<img src="images/ResNet2_integrated_gradients-2.png?raw=true"/>
